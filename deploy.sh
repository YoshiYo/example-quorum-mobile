...
exp publish --release-channel staging-1 --non-interactive

#### 4. Building Android Standalone App ####
# Start building standalone android build using `production` release channel
### exp build:android --release-channel staging-1 --non-interactive --no-publish
...
# Start building standalone android build using `production` release channel
exp build:ios --release-channel staging-1
